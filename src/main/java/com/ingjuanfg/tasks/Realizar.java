...
import static com.ingjuanfg.userinterface.ProductsPage.BOTON_CARRITO;
...
public class Realizar implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Type.theValue(datosRegistro.get(0).get("nombre")).into(INPUT_NOMBRE),
    ...
    public static Performable checkoutCompra (List<Map<String, String>> datosRegistros){
        return instrumented(Realizar.class, datosRegistros);
    }
}
